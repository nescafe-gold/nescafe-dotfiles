...
local utils = require("ui.panels.top-panel.volume-widget.utils")
...
local widget_types = {
  icon_and_text = require("ui.panels.top-panel.volume-widget.widgets.icon-and-text-widget"),
  icon = require("ui.panels.top-panel.volume-widget.widgets.icon-widget"),
  arc = require("ui.panels.top-panel.volume-widget.widgets.arc-widget"),
  horizontal_bar = require("ui.panels.top-panel.volume-widget.widgets.horizontal-bar-widget"),
  vertical_bar = require("ui.panels.top-panel.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
